...
using namespace std;
string myText ;
ifstream MyReadFile("input_Phase1.txt");
ofstream MyWriteFile("output_Phase1.txt");
...
void OS::os(){
    ...
    cout<<endl;
    //reads string with whitespace
    //cin usually terminates when it encounters whitespace
    cin.get();
}
